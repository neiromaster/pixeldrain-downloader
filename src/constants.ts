...
// Speed threshold: 1.5 MB/s = 1536 KB/s
export const DEFAULT_MIN_SPEED_THRESHOLD = 1536; // KB/s
export const PIXELDRAIN_MIN_SPEED_WITH_API = 1000000; // KB/s

// Speed check window: 10 seconds sliding window
